...
export class EditOrder extends Component {
    ...
    render() {
        const imageLink = `https://res.cloudinary.com/oluwamayowaf/image/upload/`
        return (
           <div>
        <React.Fragment>
        <div className='Product-form-header'>
            ...
            <form ref={el => (this.form = el)} onSubmit={this.editProduct} name='editproductForm' id='editproductForm'  className='Product-form'>
                {this.props.showSucess ? <div className="alert-success">Product has been edited successfully</div> : null}
